...
# What are characteristics of body part injured? Is there any improvement in preventing serious injuries? 
...
tx_injuries_top <- tx_injuries %>% 
  mutate(name_of_operation = replace(name_of_operation, 
                                     name_of_operation == "TYPHOON TEXAS ‐ AUSTIN", 
                                     "Typhoon Texas - Austin")) 

tx_injuries_top10 <- tx_injuries_top %>%
