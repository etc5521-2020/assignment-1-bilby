...
### The states with the most amusement park injuries
Analyse the tx_comp data by state, find the states with the most amusement park injuries. And create a heat map of injuries.

### The most dangerous ride in each state
Find out the most dangerous ride in each state, displaying the number of injuries and the manufacturer name. This could remind people to avoid the most dangerous ride in their state, and we can further analyse which manufacturer's products caused more injuries over the years.
