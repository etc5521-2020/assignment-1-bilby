...
## what is the most frequent words in injury description? What are characteristics of body part injured related to age, gender? What is the trend of body part injured over these years?
...
```{r yb, fig.cap="sdfsjl"}
temp %>%
  group_by(injury_year, body_part) %>%
  summarise(count = n()) %>%
  ggplot() +
  geom_point(aes(injury_year, count, col = body_part)) +
  geom_line(aes(injury_year, count, col = body_part)) -> p
